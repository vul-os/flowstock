...
export function seedDemoData() {
  ...
  const branches = [
    {
      ...
      code: "JHB",
      address: "14 Commissioner St, Johannesburg",
      is_active: 1,
    ...
    },
    {
      ...
      name: "Cape Town",
      code: "CPT",
      address: "82 Voortrekker Rd, Parow",
      is_active: 1,
      created_at: iso(daysAgo(320)),
    },
    {
      id: "br-dbn",
      name: "Durban",
      code: "DBN",
      address: "5 Umgeni Rd, Durban",
      is_active: 1,
  ...
  const addProduct = (id, name, category_id, description, data, vs) => {
    products.push({
      ...
      created_at: iso(daysAgo(between(120, 380))),
      updated_at: iso(daysAgo(between(1, 60))),
    });
  ...
  addProduct(
    "p-hexbolt",
    "Hex Bolts M6 (box of 100)",
    "cat-fast",
    "Zinc-plated class 8.8 hex bolts, boxed per 100.",
    {
  ...
  addProduct(
    "p-woodscrew",
    "Wood Screws 4×40 (box of 200)",
    "cat-fast",
    "Countersunk pozi chipboard screws.",
    {
      material: "Hardened steel",
      specifications: { headType: "Countersunk", packageQuantity: 200 },
    },
  ...
  addProduct(
    ...
    "Cordless Drill 18V",
    "cat-power",
    "Brushless 18V drill driver, 13 mm keyless chuck.",
    { specifications: { finish: "Brushless" } },
    [
      [
        "v-drill-bare",
        "Bare tool",
  ...
  addProduct(
    ...
    "cat-power",
    "900 W angle grinder with side handle.",
    {},
  ...
  addProduct(
    ...
    "Claw Hammer 450 g",
    "cat-hand",
    "Fibreglass shaft claw hammer.",
    {},
    [["v-hammer", "450 g", "HND-HAM-450", 219.0, 132.0, 15, {}]],
  );
  addProduct(
    "p-screwset",
    "Screwdriver Set 12 pc",
    "cat-hand",
    "Slotted + pozi + torx set with magnetic tips.",
    {},
    [["v-screwset", "12 piece", "HND-SDS-12", 449.0, 276.0, 10, {}]],
  );
  addProduct(
    "p-cable",
    "Twin & Earth Cable 2.5 mm²",
    "cat-elec",
    "SANS-approved surfix cable.",
    {},
    [
      [
        "v-cable-10",
  ...
  addProduct(
    ...
    "LED Floodlight 50 W",
    "cat-elec",
    "IP65 outdoor floodlight, cool white.",
    {},
  ...
  addProduct(
    ...
    "PVC Pipe 110 mm × 6 m",
    "cat-plumb",
    "Underground drainage pipe, SABS mark.",
    {},
  ...
  addProduct(
    ...
    "cat-safety",
    "Leather safety boots, steel toe cap.",
    {},
    [
  ...
  const services = [
    {
      ...
      description: "Sharpening service for saw blades and chisels.",
      hourly_rate: 350.0,
    ...
    },
    {
      ...
      description: "Bench repair of power tools, quote first.",
      hourly_rate: 480.0,
      created_at: iso(daysAgo(300)),
    },
    {
      id: "svc-cut",
      name: "Cutting & threading",
      description: "Pipe cutting and thread work per job.",
      hourly_rate: 300.0,
  ...
  const suppliers = [
    {
      id: "sup-natal",
      name: "Sipho Ndlovu",
      company_name: "Natal Fastener Co.",
      email: "orders@natalfastener.co.za",
      phone: "+27 31 555 0192",
      address: "18 Titanium Rd, Pinetown",
      tax_number: "4890123456",
      payment_terms: "30 days",
      notes: "Fastener + fixings wholesaler.",
      is_active: 1,
    },
    {
      id: "sup-power",
      name: "Anelisa Mfeka",
      company_name: "PowerTool Distributors SA",
      email: "sales@ptdsa.co.za",
      phone: "+27 11 555 0428",
      address: "2 Kyalami Blvd, Midrand",
      tax_number: "4550098821",
      payment_terms: "30 days",
      notes: "Exclusive drill/grinder distributor.",
      is_active: 1,
    },
    {
      id: "sup-electro",
      name: "Pieter van Wyk",
      company_name: "ElectroSupply CC",
      email: "accounts@electrosupply.co.za",
      phone: "+27 21 555 0871",
      address: "9 Bofors Circle, Epping",
      tax_number: "4120067543",
      payment_terms: "60 days",
      notes: "Cable and lighting.",
      is_active: 1,
    },
  ];
  ...
  const customers = [
    {
      id: "cus-mokoena",
      name: "Thabo Mokoena",
      company_name: "Mokoena Construction",
      email: "thabo@mokoenaconstruction.co.za",
      phone: "+27 82 555 0134",
      billing_address: "221 Rivonia Rd, Sandton",
      shipping_address: "Site 4, Waterfall City",
      tax_number: "9012345678",
      payment_terms: "30 days",
      credit_limit: 150000,
      notes: "Large residential contractor.",
      is_active: 1,
    },
    {
      id: "cus-capeb",
      name: "Lauren Petersen",
      company_name: "Cape Builders Collective",
      email: "lauren@capebuilders.co.za",
      phone: "+27 83 555 0917",
      billing_address: "12 Bree St, Cape Town",
      shipping_address: "12 Bree St, Cape Town",
      tax_number: "9155502211",
      payment_terms: "30 days",
      credit_limit: 80000,
      notes: "",
      is_active: 1,
    },
    {
      id: "cus-umhlanga",
      name: "Naledi Zungu",
      company_name: "Umhlanga Property Care",
      email: "naledi@upcare.co.za",
      phone: "+27 84 555 0555",
      billing_address: "77 Lighthouse Rd, Umhlanga",
      shipping_address: "77 Lighthouse Rd, Umhlanga",
      tax_number: "9223301199",
      payment_terms: "14 days",
      credit_limit: 40000,
      notes: "Maintenance company, weekly orders.",
      is_active: 1,
    },
    {
      id: "cus-walkin",
      ...
      payment_terms: "cash",
      credit_limit: 0,
      notes: "Aggregated retail counter sales.",
      is_active: 1,
    },
  ];
    ...
    peers: [
      {
        ...
        url: "http://10.0.4.21:7365",
        enabled: 1,
        last_sync_at: iso(daysAgo(0, 8)),
        last_status: "ok: pushed 12, pulled 3",
      },
      {
        id: "peer-dbn",
        name: "Durban branch",
        url: "http://10.0.6.14:7365",
        enabled: 1,
        last_sync_at: iso(daysAgo(0, 8)),
        last_status: "ok: pushed 12, pulled 9",
      },
    ],
  };
  ...
  variants.forEach((v) => {
    branches.forEach((b, i) => {
      const base = Math.max(
        2,
        Math.round((v.reorder_point || 5) * (2.6 - i * 0.5)),
      );
      move(
        v.id,
        b.id,
  ...
  const poDefs = [
    {
      id: "po-1",
      supplier_id: "sup-natal",
      branch_id: "br-jhb",
      ago: 45,
      status: "received",
      items: [
        ["v-hexbolt-30", 60, 122.5],
        ["v-hexbolt-50", 40, 158.0],
        ["v-woodscrew", 80, 78.0],
      ],
    },
    {
      id: "po-2",
      supplier_id: "sup-power",
      branch_id: "br-jhb",
      ago: 21,
      status: "partially_received",
      items: [
        ["v-drill-bare", 10, 1305.0],
        ["v-drill-kit", 6, 2440.0],
        ["v-grinder", 12, 585.0],
      ],
    },
    {
      id: "po-3",
      supplier_id: "sup-electro",
      branch_id: "br-cpt",
      ago: 9,
      status: "sent",
      items: [
        ["v-cable-10", 40, 196.0],
        ["v-cable-100", 6, 1820.0],
        ["v-flood", 24, 265.0],
      ],
    },
    {
  ...
  poDefs.forEach((def) => {
    ...
    tables.purchase_orders.push({
      ...
      order_date: iso(daysAgo(def.ago)),
      expected_delivery_date: iso(daysAgo(def.ago - 14)),
      status: def.status,
      subtotal,
      tax_amount: tax,
      total_amount: subtotal + tax,
      notes: "",
      created_at: iso(daysAgo(def.ago)),
    });
    def.items.forEach(([vid, qty, price], i) => {
      ...
      if (received > 0)
        move(
          ...
          "purchase_order",
          def.id,
          daysAgo(Math.max(def.ago - 7, 1), 11),
        );
    });
  });
  ...
  for (let ago = 70; ago >= 0; ago -= between(1, 4)) {
    ...
    for (let li = 0; li < lineCount; li++) {
      ...
      const qty = Math.min(
        want,
        Math.max(0, Math.floor((onHand[key] || 0) - 2)),
      );
      if (qty <= 0) continue;
    ...
    if (rand() < 0.25) {
      ...
      tables.order_services.push({
        id: `${id}-s0`,
        order_id: id,
        service_id: svc.id,
        hours,
        hourly_rate: svc.hourly_rate,
        total_price: hours * svc.hourly_rate,
  ...
  tables.orders
    ...
    .forEach((o, i) =>
      tables.payments.push({
        ...
        direction: "in",
        amount: Math.round(o.total_amount * 0.5),
        payment_date: iso(daysAgo(2 + i)),
        method: "eft",
        note: `part payment ${o.order_number}`,
        created_at: iso(daysAgo(2 + i)),
      }),
    );
  tables.payments.push({
    id: nextId("pay"),
    ...
    direction: "out",
    amount: 15000,
    payment_date: iso(daysAgo(5)),
    method: "eft",
    note: "part payment PO-2026-002",
  ...
  return {
    ...
    sync: {
      ...
      port: "8787",
      bind_addr: "0.0.0.0",
      secret: "demo-sync-secret-not-real",
    },
    tables,
  };
}
